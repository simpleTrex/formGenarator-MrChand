package com.adaptivebp.modules.formbuilder.dto.request;
...
public class UpdateDomainModelRequest {
    ...
    public Boolean getSharedWithAllApps() { return sharedWithAllApps; }
    public void setSharedWithAllApps(Boolean sharedWithAllApps) { this.sharedWithAllApps = sharedWithAllApps; }
    public Set<String> getAllowedAppIds() { return allowedAppIds; }
    public void setAllowedAppIds(Set<String> allowedAppIds) { this.allowedAppIds = allowedAppIds; }
