package com.adaptivebp.modules.appmanagement.dto.response;
...
public class AppUserResponse {
    ...
    public List<AppGroupMembershipInfo> getAppGroups() { return appGroups; }
    public void setAppGroups(List<AppGroupMembershipInfo> appGroups) { this.appGroups = appGroups; }
