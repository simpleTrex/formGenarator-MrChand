...
public class WorkflowState {
    ...
    public Map<String, StatePermissions> getPermissions() { return permissions; }
    public void setPermissions(Map<String, StatePermissions> permissions) { this.permissions = permissions; }
